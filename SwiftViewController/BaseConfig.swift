...
public struct BaseConfig {
    ...
    /// 返回按钮图片
    public var backButtonImage = UIImage(named: "icon_navigation_back", in: Bundle(identifier: "org.cocoapods.SwiftBaseViewController"), compatibleWith: nil)
    
    /// 关闭按钮图片
    public var closeButtonImage = UIImage(named: "icon_navigation_close", in: Bundle(identifier: "org.cocoapods.Swift.BaseViewController"), compatibleWith: nil)
